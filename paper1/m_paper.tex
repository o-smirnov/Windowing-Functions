...
\caption{Results of Fig.~\ref{fig:results-example} normalized to the \BIN{25}{2.5} averaging curve.}
...
full synthesis, in terms of image-plane sensitivity this gain is ephemeral. In our case, at \BIN{100}{10} sampling, we
...
integration time in seconds is 10 times the channel width in MHz (hence the use of \BIN{100}{10} etc. above.) 
...
The non-overlapping sinc-1x1 BDWF has improved smearing performance compared to \BIN{100}{10} averaging. When tuned
...
suppression does not exceed that achieved by \BIN{100}{10} averaging. We may therefore conclude that overlapping BDWFs
