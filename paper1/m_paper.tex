...
sensitivity trade-off, and show that in certain regimes a favorable compromise can be achieved. We show the application of this technique to simulated data from the JVLA and EVN.
\end{abstract}
\begin{keywords}
...
where $\bmath{u}$ is the baseline vector (in a coordinate system fixed to the sky), 
and $\bmath{\sigma}_0$ is the phase centre (or fringe stopping centre) of the observation.
...
scientific observation case, which may be related to the size of the primary
...
centres.
\end{itemize}
%Here, we can identify two regimes:
%
%\begin{itemize}
...
%On the other hand, smearing also has a useful side effect. In interferometry, anything outside the desired FoI is unwanted signal.
...
\FilterFigure{./Figures/gaussiangrey.pdf}{./Figures/freq_resp_gaussiangrey.pdf}{Gaussian  and its IPR.}{fig:wf:gauss}
...
\FilterFigure{./Figures/prolategrey.pdf}{./Figures/freq_resp_prolategrey.pdf}{Prolate window (of oder zeros) and its IPR.}{fig:wf:prolate}
