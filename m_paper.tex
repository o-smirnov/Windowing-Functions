...
Overlap 
		\textit{BDWF's}: $\Delta_u t= [225, 250]$.}\label{fig:max-integ-time-sinc-w1x1fov2}\end{minipage}
\begin{minipage}{0.45\linewidth}\includegraphics[width=1.\textwidth]{./Figures/max-integ-time-sinc-w100x1fov2.pdf}\caption{Overlap 
		\textit{BDWF's}: $\Delta_u t= [225, 250]$.}\label{fig:max-integ-time-sinc-w100x1fov2}\end{minipage}\\
...
\begin{minipage}{0.45\linewidth}\includegraphics[width=1\textwidth]{./Figures/max-integ-time-bessel-w100x1fov2.pdf}\caption{Overlap 
		\textit{BDWF's}: $\Delta_u t=\emptyset$.}\label{fig:max-integ-time-bessel-w1x1-fov2}\end{minipage}
\end{figure*}
...
In these case, each of these sky model is simulated with a JVLA HR-MS of 1 timeslots synthesis, with a short integration time, $\Delta 
t^{hrms}=0.1s$ at 1.4GHz. The aims of a short HR-MS integration time is to avoid time direction smearing and accurately evaluate
smearing in the frequency direction. We considered 150 channels of width $\Delta \nu^{hrms}$=125kHz. We therefore applied the actual method 
(simple averaging) and our methods both in the frequency direction, each result is save into a LR-MS of 1 timeslot synthesis, with 0.1s 
integration time and 1 channels of width 6.25MHz. We considered, $\nu^{hrms}_{start}=\{1min30s,6250kHz\}$ 
$\nu^{lrms}_{start}=\{1min30s,6250kHz\}$, $\nu^{hrms}_{end}=\{7min30s$,xxxkHz\} and $\nu^{lrms}_{end}=\{6min,xxxkHz\}$.  
Fig.\ref{fig:max-integ-freq-sinc-w1x1-fov2} and Fig.\ref{fig:max-integ-time-sinc-w1x50-fov2}  are the results 
of  $Bl$-$sinc$ $W0 \times n_{\nu,ovlp}$. Fig.\ref{fig:max-integ-freq-bessel-w1x1-fov2} and Fig.\ref{fig:max-integ-freq-bessel-w1x50-fov2} 
are the results of  $Bl$-J$_0$ $W0 \times n_{\nu,ovlp}$, with $n_{\nu,ovlp}=\{0,50\}$. These results shows that:
\begin{itemize}
...
% *********************** Scripts that created these plots ***********************************
%plot.plot(wind1='/home/atemkeng/TempleFull/DATA/Maxfreqtime-sinc-fov2-window/',title1=r'Avg[circle mark] vs. Bl-sinc-W$1\times 1$ [triangle 
      %mark], FoV=2$^\circ$')
%plot.plot(wind1='/home/atemkeng/TempleFull/DATA/Maxfreqtime-sinc-fov2-overlap',title1=r'Avg[circle mark] vs. Bl-sinc-W$100\times 50$ 
      %[triangle mark], FoV=2$^\circ$')
%plot.plot(wind1='/home/atemkeng/TempleFull/DATA/Maxfreqtime-bessel-fov2-window/',title1=r'Avg[circle mark] vs. Bl-J$_0$-W$1\times 1$ 
      %[triangle mark], FoV=2$^\circ$')
%plot.plot(wind1='/home/atemkeng/TempleFull/DATA/Maxfreqtime-bessel-fov2-overlap',title1=r'Avg[circle mark] vs. Bl-J$_0$-W$100\times 50$ 
      %[triangle mark], FoV=2$^\circ$')
\begin{figure*}
  \centering
