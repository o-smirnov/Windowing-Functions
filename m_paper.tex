...
In the table below, we present the terminology that will be using in this paper in contrast of the terminology of  conventional signal 
processing.\\ 
\begin{tabular}{*3{c}}\\
 \multicolumn{3}{|c|}{}
...
\end{eqnarray*}
\end{itemize}
The tables below summarized the overall  theoretical rms noise ratio and the simulation one.\\
\begin{tabular}{*3{c}}
 \multicolumn{3}{|c|}{}\\
 \begin{tabular}{|l|l|l|l|}
