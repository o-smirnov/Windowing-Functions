...
% \section{Correlation filters}
% read Aard paper on VLBI correlators, read Griffin thesis on correlators etc
% % see page 19:/media/atemkeng/New Volume/PhD documents/GPU/dissertation.pdf
% % Figure 2.1: Matching (correlating) a query image with the template (correlation filter). For computational efficiency
% % matching is done in the Fourier domain. Sample matching outputs for an authentic and impostor input are shown.
% % describe the correlation process
% \begin{itemize}
%   \item Maybe when writing I will have more inspiration
% \end{itemize}
